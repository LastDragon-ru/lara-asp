    ...
    public static function dataProviderCall(): array {
        return (new CompositeDataProvider(
            ...
            new ArrayDataProvider([
                'field'      => [
                    [
                        'query'    => 'select * from "test_objects" where "field" not like ?',
                        'bindings' => ['abc'],
                    ],
                ...
                'field.path' => [
                    [
                        'query'    => 'select * from "test_objects" where "path"."to"."field" not like ?',
                        'bindings' => ['abc'],
                    ],
                ...
                'resolver'   => [
                    [
                        'query'    => 'select * from "test_objects" where "path__to__field" not like ?',
                        'bindings' => ['abc'],
                    ],
                    new Field('path', 'to', 'field', 'operator name should be ignored'),
                    static function (self $test): Argument {
