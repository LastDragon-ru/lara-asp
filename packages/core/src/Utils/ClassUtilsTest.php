...
class ClassUtilsTest extends TestCase {
    ...
    public function dataProviderGetConstants(): array {
        return [
            'class - without prefix - non recursive' => [['A', 'PUBLIC_A'], ClassUtilsTest__testGetConstants::class, null, false],
            'class - with prefix - non recursive'    => [['PUBLIC_A'], ClassUtilsTest__testGetConstants::class, 'PUBLIC_', false],
            'child - without prefix - non recursive' => [['PUBLIC_B'], ClassUtilsTest__testGetConstants__Child::class, null, false],
            'child - without prefix - recursive'     => [['A', 'PUBLIC_A', 'PUBLIC_B'], ClassUtilsTest__testGetConstants__Child::class, null, true],
            'child - with prefix - recursive'        => [['PUBLIC_A', 'PUBLIC_B'], ClassUtilsTest__testGetConstants__Child::class, 'PUBLIC_', true],
        ];
    }
    // </editor-fold>
}
